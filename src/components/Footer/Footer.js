  ...
  window.onload = function (e) {
    ...
    submitBtn.addEventListener("click", function (e) {
      ...
      if (inputText.match(regexEmail)) {
        ...
        document.getElementById("invalid-text").style.color = "#03fc3d";
        document.getElementById("invalid-text").innerHTML = "Done!!";
      } else {
        document.getElementById("invalid-text").style.display = "block";
      }
    });
        ...
        <div className="footer-heading">
          ...
          <div className="input-field">
            <input
              ...
              id="text-input"
            />
            <button type="submit" className="contact-btn" id="submit-btn">
              Contact Us
            </button>
            <br />
            <span id="invalid-text">Invalid e-mail address</span>
          </div>
        </div>
